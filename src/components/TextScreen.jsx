...
import { View, Text, StyleSheet, TouchableOpacity, SafeAreaView, Alert, StatusBar, ScrollView, TextInput } from 'react-native';
        ...
        <SafeAreaView style={[styles.container, { backgroundColor }]}>
            <StatusBar barStyle={theme === 'light' ? 'dark-content' : 'light-content'} backgroundColor={backgroundColor} />
              ...
              <View style={[styles.header, { borderBottomColor: borderColor }]}>
                                  ...
                                  <Text style={[styles.headerTitle, { color: textColor }]}>Text Verification</Text>
                                  <TouchableOpacity
