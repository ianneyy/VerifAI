            ...
            <View
              style={[
                styles.resultFlex,
                {
                  borderLeftWidth: 3,
                  borderLeftColor:
                    sourceCredible === 'Credible' ? '#9DFFBA' : '#FF797B',
                },
              ]}>
              <View
                style={{
            ...
            <View
              style={[
                styles.resultFlex,
                {
                  borderLeftWidth: 3,
                  borderLeftColor:
                    prediction === 'Credible' ? '#9DFFBA' : '#FF797B',
                },
              ]}>
              <View
                style={{
                ...
                <Text
                  style={[
                    styles.recognizedText,
                    {
                      color: prediction === 'Credible' ? '#9DFFBA' : '#FF797B',
                      fontWeight: 'bold',
                    },
                  ]}>
          ...
          <TouchableOpacity
            ...
            <View
              style={[
                ...
                {
                  borderLeftWidth: 3,
                  borderLeftColor: articleCount > 1 ? '#9DFFBA' : '#FF797B',
                },
              ]}>
              <View
                style={{
                ...
                <Text
                  style={[
                    styles.recognizedText,
                    {
                      color: articleCount > 1 ? '#9DFFBA' : '#FF797B',
                      fontWeight: 'bold',
                    },
                  ]}>
